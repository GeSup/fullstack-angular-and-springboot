...
import com.course_code.ecommerce.dao.CustomerRepository;
...
//        orderItems.forEach(item -> order.add(item)); this can be replaced with lambda
    ...
    @Override
    public PaymentIntent createPaymentIntend(PaymentInfo paymentInfo) throws StripeException {
